#!/bin/bash
# GitHub Repository Setup Script - Environment Variables Version
# Usage: GITHUB_TOKEN=xxx GITHUB_USER=xxx ./setup-github-env.sh

set -e

echo "=========================================="
echo "GitHub Repository Setup (Environment Mode)"
echo "=========================================="
echo ""
...
if [ ! -f "README.md" ] || [ ! -d "agents" ]; then
    echo "Error: Please run from ai-model-research-team directory"
    exit 1
fi
